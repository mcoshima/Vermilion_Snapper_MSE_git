#Function for determining what value to put in the forecast.ss file so that you actually achieve SPR 30%
##Loop runs through a vector of possible values and calculates the actual SPR value from the projections. 
##pbPost will notify my phone when an iteration has completed and what the test value was and what the actual SPR was calculated. 
##The loop will end once a value that is between .299 and .31 (~.30) is reached.
